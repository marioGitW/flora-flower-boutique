export const site = {
  ...
  // The shop's name on Google Maps. Local search matches the site to that
  // listing by name, so the title and structured data use it too.
  nameMaps: "Цвеќара Флора",
  ...
  // Confirmed by the owner: Monday to Saturday, closed Sunday.
  hours: [{ days: "Понеделник – Сабота", time: "10:00 – 18:00ч" }],
  // The same hours for schema.org. Keep the two in step.
  openingHours: {
  ...
  meta: {
    title: "Цвеќара Флора — букети и цвеќе во Куманово",
    // Kept under ~155 characters so search results show it whole.
    description:
      "Цвеќара Флора во Куманово — букети, аранжмани во кутија, подароци за новороденче, крштевки, свадби и венци, по нарачка. Јавете се: 078 207 443.",
